...
export const overviewTabPO = {
  clickTab: '[data-test="app-details__tabItem overview"]',
  goToComponents: '[data-test="go-to-components-tab"]',
  addComponent: '[data-test="add-component"] > a',
};

export const activityTabPO = {
  clickTab: '[data-test="app-details__tabItem activity"]',
};

export const componentsTabPO = {
  clickTab: '[data-test="app-details__tabItem components"]',
...
export const integrationTestsTabPO = {
  clickTab: '[data-test="app-details__tabItem integrationtests"]',
...
export const createBuildStepPO = {
  mergePRButton: '[data-test="merge-button"]',
